...
Optional: [Phase 12B: Python API Testing](02-python-api-testing.md)

Then continue to [Phase 13: Enable Kubernetes In Docker Desktop](../04-kubernetes/01-docker-desktop-kubernetes.md).
